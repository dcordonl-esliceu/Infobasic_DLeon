...
function infobasic_scripts(){
    wp_enqueue_script('bootstrap_js', get_theme_file_uri('inc/js/bootstrap.bundle.min.js'), array('jquery'), '4.5', true);
    wp_enqueue_style('bootstrap_css', get_theme_file_uri('inc/css/bootstrap.min.css'), array(), '4.5', 'all');
    wp_enqueue_style('style_css', get_theme_file_uri('style.css'), array(), filemtime(get_theme_file_path('style.css')), 'all');
}
